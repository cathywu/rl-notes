...
class DeepQLearner():
    ...
    def execute(self, env, num_episodes, epsilon_decay):
    ...
    def test_dqn(self, env, qfunction, epsilon=0.0):
...
if __name__ == "__main__":
    ...
    qfunction = DeepQLearner(env, hidden_size, learning_rate, discount_factor).execute(env, num_episodes, epsilon_decay)
